...
<head>
    ...
    <title>Tugas 1 - My Profile</title>
</head>
        ...
        <ol class="relative border-s border-gray-200 dark:border-gray-700">
            <li class="mb-10 ms-6">
                ...
                <div
                    ...
                    <div class="items-center justify-between mb-3 sm:flex">
                        <time
                            class="mb-1 text-xs font-normal text-gray-400 sm:order-last sm:mb-0"><?= $tahunSMP ?></time>
            ...
            <li class="mb-10 ms-6">
                ...
                <div
                    ...
                    <div class="items-center justify-between mb-3 sm:flex">
                        <time
                            class="mb-1 text-xs font-normal text-gray-400 sm:order-last sm:mb-0"><?= $tahunSMK ?></time>
